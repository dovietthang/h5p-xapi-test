...
!function (r) {
    ...
    var e, i = ((e = {endpoint: "http://localhost/test-xapi/"}).auth = "Basic " + toBase64("tom:1234"), e);
    ...
    t.prototype.xapiVersion = "1.0.1", t.prototype.prepareStatement = function (t) {
        ...
        }(r, n, x, e), (u = new XDomainRequest).open(d.method, d.url); else for (var C in (u = new XMLHttpRequest).withCredentials = c, u.open(r, n, null != o), x) u.setRequestHeader(C, x[C]);
    ...
    u.launch = function s(a, p, c) {
        ...
        try {
            ...
            if (d("encrypted"), s.terminate = function (t) {
                ...
                i.withCredentials = !0, i.crossDomain = !0, i.open("POST", e.toString(), !1), i.setRequestHeader("Content-type", "application/json"), i.send(JSON.stringify({
                    code: 0,
